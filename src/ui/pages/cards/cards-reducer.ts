...
const slice = createSlice({
    ...
    reducers: {
        ...
        searchQuestions(state, action: PayloadAction<{cardQuestion: string}>){
            return {...state, params: {...state.params, cardQuestion: action.payload.cardQuestion}}
        },
        searchAnswer(state, action: PayloadAction<{cardAnswer: string}>){
...
//ACTION CREATORS
export const {setCardsAC, setCardsTotalCountAC, setPackIdAC, sortCardsAC, searchQuestions, searchAnswer} = slice.actions;
